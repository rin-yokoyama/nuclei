# NuclideGenerator.py generated by R. Yokoyama 10/04/2018
import sqlite3
import re
...
class NuclideGenerator:
    ...
    def generateNuclides(self, table_name):
        ...
        # reads Pxn and halflife values from the database
        # and generates a list of NuclideProperty objects
